...
{//stoneworks
    ...
    VanillaFactory.createItem("fireclay_big").register();
    ...
    VanillaFactory.createBlock("awakened_umberrack_bricks", <blockmaterial:rock>).register();
...
{////////////////////////////////////metals
    ...
    VanillaFactory.createItem("copper_reject").register();
    registerMoltenMetal("dore", Color.fromHex("59561d"));
    VanillaFactory.createFluid("blue_acid", Color.fromHex("6e7ec5")).register();
    ...
    VanillaFactory.createItem("zinc_pellet").register();
    VanillaFactory.createItem("zinc_pellet2").register();
    registerMetal("zinc");
    ...
    //silver
    VanillaFactory.createBlock("argyrodite_ore", <blockmaterial:rock>).register();
    ...
    var relic_ingot2 = VanillaFactory.createItem("relic_ingot2");
        relic_ingot2.glowing = true;
        relic_ingot2.register();
    ...
    VanillaFactory.createItem("lubarium_ingot").register();
    VanillaFactory.createItem("lubarium_dust").register();
    VanillaFactory.createBlock("lubarium_block", <blockmaterial:rock>).register();
    registerMoltenMetal("lubarium", Color.fromHex("c9f26e"));

    VanillaFactory.createItem("solar_lubarium_ingot").register();
    VanillaFactory.createItem("solar_lubarium_plate").register();
    VanillaFactory.createItem("solar_lubarium_dust").register();
    VanillaFactory.createBlock("solar_lubarium_block", <blockmaterial:rock>).register();
    registerMoltenMetal("solar_lubarium", Color.fromHex("9cd157"));
    ...
    var cursed_gold_altar1 = VanillaFactory.createBlock("cursed_gold_altar1", <blockmaterial:rock>);
    cursed_gold_altar1.axisAlignedBB = mods.contenttweaker.AxisAlignedBB.create(0.2, 0.0, 0.2, 0.8, 1.0, 0.8);
    cursed_gold_altar1.setBlockLayer("TRANSLUCENT");
    cursed_gold_altar1.setLightOpacity(0);
    cursed_gold_altar1.setTranslucent(true);
    cursed_gold_altar1.setFullBlock(false);
    cursed_gold_altar1.register();
    var cursed_gold_altar2 = VanillaFactory.createBlock("cursed_gold_altar2", <blockmaterial:rock>);
    cursed_gold_altar2.axisAlignedBB = mods.contenttweaker.AxisAlignedBB.create(0.3, 0.0, 0.3, 0.7, 1.0, 0.7);
    cursed_gold_altar2.setBlockLayer("TRANSLUCENT");
    cursed_gold_altar2.setLightOpacity(0);
    cursed_gold_altar2.setTranslucent(true);
    cursed_gold_altar2.setFullBlock(false);
    cursed_gold_altar2.register();
    var cursed_gold_altar3 = VanillaFactory.createBlock("cursed_gold_altar3", <blockmaterial:rock>);
    cursed_gold_altar3.axisAlignedBB = mods.contenttweaker.AxisAlignedBB.create(0.4, 0.0, 0.4, 0.6, 1.0, 0.6);
    cursed_gold_altar3.setBlockLayer("TRANSLUCENT");
    cursed_gold_altar3.setLightOpacity(0);
    cursed_gold_altar3.setTranslucent(true);
    cursed_gold_altar3.setFullBlock(false);
    cursed_gold_altar3.register();
    ...
    VanillaFactory.createItem("jet_alloy_ingot").register();
    VanillaFactory.createItem("jet_alloy_plate").register();
    VanillaFactory.createBlock("jet_alloy_block", <blockmaterial:rock>).register();
    ...
    VanillaFactory.createBlock("kikeridan_ore", <blockmaterial:rock>).register();
    VanillaFactory.createItem("kikeridan_pieces").register();
    VanillaFactory.createItem("kikeridan_chunk").register();
    VanillaFactory.createItem("kikeridan_ingot").register();
    VanillaFactory.createItem("kikeridan_plate").register();
    VanillaFactory.createItem("kikeridan_gear").register();
    VanillaFactory.createBlock("kikeridan_block", <blockmaterial:rock>).register();
    VanillaFactory.createItem("kikeridan_dust").register();
    registerMoltenMetal("kikeridan", Color.fromHex("84cc6e"));

    VanillaFactory.createItem("kikeridan_crystal").register();
    VanillaFactory.createItem("kikeridan_shard").register();
    VanillaFactory.createItem("kikeridan_cluster").register();
    VanillaFactory.createItem("kikeridan_dirty_dust").register();

    VanillaFactory.createItem("vortexed_base").register();
    VanillaFactory.createItem("vortexed_ingot").register();

    VanillaFactory.createItem("xenotime").register();
    VanillaFactory.createBlock("xenotime_ore", <blockmaterial:rock>).register();

    VanillaFactory.createItem("onyx").register();
    VanillaFactory.createBlock("onyx_block", <blockmaterial:rock>).register();
    VanillaFactory.createItem("onyx_mirror").register();
    ...
    VanillaFactory.createBlock("barite_ore", <blockmaterial:rock>).register();
    ...
    VanillaFactory.createFluid("pollucite2", Color.fromHex("674a0a")).register();
    ...
    VanillaFactory.createItem("perovskite_ingot").register();
    VanillaFactory.createItem("perovskite_plate").register();
    VanillaFactory.createBlock("perovskite_block", <blockmaterial:rock>).register();
    
    VanillaFactory.createItem("perovskite2_ingot").register();
    VanillaFactory.createItem("perovskite2_plate").register();
    VanillaFactory.createBlock("perovskite2_block", <blockmaterial:rock>).register();

    VanillaFactory.createItem("vanadium_alloy_ingot").register();
    VanillaFactory.createBlock("vanadium_alloy_block", <blockmaterial:rock>).register();
    ...
    VanillaFactory.createItem("awakened_carminium_ingot").register();
...
{//filter
    ...
    VanillaFactory.createItem("filter_yellow").register();
...
{//components
    ...
    VanillaFactory.createItem("signal_sender").register();
    ...
    {//satellites
        ...
        VanillaFactory.createItem("satellite_plating3").register();
...
{//oil things
    ...
    VanillaFactory.createFluid("cold_crude", Color.fromHex("181a28")).register();
    VanillaFactory.createFluid("cold_diesel", Color.fromHex("423770")).register();
    VanillaFactory.createFluid("cold_ambrosium", Color.fromHex("4e5128")).register();
}
...
{//indium
    ...
    VanillaFactory.createItem("layered_wafers").register();
...
{//early game
    VanillaFactory.createItem("soggy_paper").register();
...
{//ex nihilo
    var grate = VanillaFactory.createBlock("grate", <blockmaterial:rock>);
    grate.setBlockLayer("TRANSLUCENT");
    grate.setLightOpacity(0);
    grate.setTranslucent(true);
    grate.setFullBlock(false);
    grate.register();
}
{//roots
    ...
    VanillaFactory.createItem("entwood_heart").register();
...
{//erebus  
    ...
    VanillaFactory.createItem("activated_motor").register();
}
{//extra u
...
{//thermal
    ...
    VanillaFactory.createItem("ender_crystal").register();
    VanillaFactory.createFluid("postender", Color.fromHex("8cf4e2")).register();
...
{//meka
    ...
    VanillaFactory.createFluid("supersalty", Color.fromHex("bee4e0")).register();

    var tar_light = VanillaFactory.createBlock("tar_light", <blockmaterial:rock>);
    tar_light.lightValue = 1;
    tar_light.register();

    VanillaFactory.createItemFood("cheesestone", 2).register();
    VanillaFactory.createBlock("cheesestone_ore", <blockmaterial:rock>).register();
...
{//actually addition
    ...
    VanillaFactory.createItem("yellow_dust").register();
    addWater("yellow");
...
{//enderio
    ...
    VanillaFactory.createItem("prepared_silicon").register();
    ...
    VanillaFactory.createItem("capacitor_base").register();
    ...
    VanillaFactory.createItem("capacitor_dust").register();
...
{//botania
    ...
    addItem("petals1", "rare", 64);
    addItem("petals2", "rare", 64);
    addItem("petals3", "rare", 64);
    addItem("petals4", "rare", 64);
    addItem("petals5", "rare", 64);
...
{//astral
    ...
    VanillaFactory.createItem("temperature_control").register();
    VanillaFactory.createItem("quartz_clock").register();
    VanillaFactory.createItem("state_detector").register();
    VanillaFactory.createItem("gapo4").register();
    VanillaFactory.createItem("atomic_clock").register();

    VanillaFactory.createItem("csitl").register();
    VanillaFactory.createItem("scintillator").register();

    VanillaFactory.createItem("cool_sulfur").register();
...
{//project e
    ...
    registerMoltenMetal("diamond2", Color.fromHex("2d4d67"));
...
{//alchemistry
    ...
    //VanillaFactory.createFluid("propane", Color.fromHex("5c1b28")).register();
    VanillaFactory.createItem("propylene").register();
    ...
    VanillaFactory.createItem("ac2o").register();
    ...
    VanillaFactory.createItem("selenocysteine").register();
    ...
    VanillaFactory.createItem("phenol").register();
    VanillaFactory.createItem("chlorobenzene").register();
    VanillaFactory.createItem("benzyl_chloride").register();
    VanillaFactory.createItem("benzaldehyde").register();
    VanillaFactory.createItem("ethylbenzene").register();
    VanillaFactory.createItem("diphenylmethane").register();
    VanillaFactory.createItem("benzophenone").register();
    ...
    //VanillaFactory.createItem("").register();
    VanillaFactory.createItem("ethylene_oxide").register();
    VanillaFactory.createItem("ethylene_glycol").register();
    VanillaFactory.createItem("dioxane").register();

    //cubane line
    VanillaFactory.createItem("adipic_acid").register();
    VanillaFactory.createItem("cyclopentanone").register();
    VanillaFactory.createItem("cyclopentanone_ethylene_ketal").register();
    VanillaFactory.createItem("tribrom_cyclopentanone_ethylene_ketal").register();
    VanillaFactory.createItem("tribrom_cyclopentanone_ethylene_ketal2").register();
    VanillaFactory.createItem("precubane_diketal").register();
    VanillaFactory.createItem("precubane").register();
    VanillaFactory.createItem("cubane_dicarboxylic_acid").register();
    VanillaFactory.createItem("cubane").register();
    VanillaFactory.createItem("octonitrocubane").register();
    VanillaFactory.createItem("octofluorocubane").register();
    VanillaFactory.createItem("electron_cheese").register();

    VanillaFactory.createItem("butadiene").register();
    VanillaFactory.createItem("acrylonitrile").register();
    VanillaFactory.createItem("adiponitrile").register();
    VanillaFactory.createItem("hexamethylenediamine").register();
    VanillaFactory.createItem("nylon").register();

    VanillaFactory.createItem("terephthalic_acid").register();
    VanillaFactory.createItem("chloroxylen").register();
    VanillaFactory.createItem("tcl").register();
    VanillaFactory.createItem("nitrochlorobenzene").register();
    VanillaFactory.createItem("ppd").register();
    VanillaFactory.createItem("kevlar").register();

    VanillaFactory.createItem("xenon_gold").register();
...
{//research
    ...
    VanillaFactory.createItem("research_teleportation").register();
    VanillaFactory.createItem("mana_bucket").register();
    ...
    VanillaFactory.createItem("research_oreberry").register();
