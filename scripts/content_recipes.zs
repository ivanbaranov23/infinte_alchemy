...
{//metals
    ...
    add3x3Recipe(<alchemistry:ingot:12>, <contenttweaker:magnesium_block>);
    ...
    add3x3Recipe(<alchemistry:ingot:45>, <contenttweaker:rhodium_block>);
    ...
    add3x3Recipe(<alchemistry:ingot:81>, <contenttweaker:thallium_block>);
