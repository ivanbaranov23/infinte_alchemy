...
addRecycle(<modularmachinery:research_station_controller>, [
...
recipes.addShaped("mm_large_sifter", <modularmachinery:large_sifter_controller>, [
...
recipes.addShaped("mm_biolab_controller", <modularmachinery:biolab_controller>, [
	...
	[<mekanism:plasticblock:15>, <modularmachinery:garden_cloche_controller>, <mekanism:plasticblock:15>]
]);
recipes.addShaped("mm_pworld_oregen", <modularmachinery:pworld_oregen_controller>, [
...
recipes.addShaped("mm_worm_pit_controller", <modularmachinery:worm_pit_controller>, [
...
//EIO
recipes.addShaped("mm_large_cobblegen_controller", <modularmachinery:large_cobblegen_controller>, [
...
recipes.addShaped("mm_bonsai_controller", <modularmachinery:bonsai_controller>, [
...
recipes.addShaped("mm_tingalum_oven_controller", <modularmachinery:tignalum_oven_controller>, [
	...
	[<contenttweaker:tignalum_blast_brick>, <modularmachinery:high_oven_controller>, <contenttweaker:tignalum_blast_brick>]
]);

//bloodmagic
recipes.addShaped("mm_blood_meat_infuser_controller", <modularmachinery:blood_meat_infuser_controller>, [
...
recipes.addShaped("mm_regen_chamber_controller", <modularmachinery:regen_chamber_controller>, [
...
recipes.addShaped("mm_luck_extractor_controller", <modularmachinery:luck_extractor_controller>, [
...
mods.extendedcrafting.TableCrafting.addShaped(0, <modularmachinery:super_mixer_controller>, [
...
//botania
mods.extendedcrafting.TableCrafting.addShaped(0, <modularmachinery:mana_bifuser_controller>, [
	...
	[<moreplates:manasteel_plate>, <modularmachinery:energy_infuser_controller>, <contenttweaker:flesh_support>, <modularmachinery:energy_infuser_controller>, <moreplates:manasteel_plate>], 
	[<botania:bellows>, <botania:pool>, <contenttweaker:mana_frame>, <botania:pool>, <botania:bellows>], 
	[<botania:quartztypeelf>, <modularmachinery:energy_infuser_controller>, <contenttweaker:flesh_support>, <modularmachinery:energy_infuser_controller>, <botania:quartztypeelf>], 
...
mods.botania.ElvenTrade.addRecipe(
	[<modularmachinery:flower_controller>], [
...
mods.extendedcrafting.TableCrafting.addShaped(0, <modularmachinery:rune_cutter_controller>, [
...
mods.extendedcrafting.TableCrafting.addShaped(0, <modularmachinery:rune_cracker_controller>, [
...
{var rec = RecipeBuilder.newBuilder("satellite_assembler_drone", "satellite_launch_pad", 2000);
    ...
    rec.addItemOutput(<modularmachinery:space_assembler_controller>);
...
{//
    ...
    rec.addItemOutput(<modularmachinery:donut_controller>);
	rec.build();
}
