...
static all_metals as IItemStack[string][string] = {
    ...
    kovar: {
        ingot: <contenttweaker:kovar_ingot>,
        block: <contenttweaker:kovar_ingot> * 9,
        singularity: <extendedcrafting:singularity_custom:110>
    },
    ...
    balloy: {
        ingot: <contenttweaker:balloy_ingot>,
        plate: <contenttweaker:balloy_plate>,
        block: <contenttweaker:balloy_block>,
        dust: <contenttweaker:balloy_dust>,

        ball: <contenttweaker:balloy_ball>,
        singularity: <extendedcrafting:singularity_custom:72>
    },
    ...
    thermal_paste: {
        ...
        block: <contenttweaker:thermal_paste> * 9,
        dust: <contenttweaker:thermal_paste>
    },
    thermal_steel: {
    ...
    nether_cluster: {
        ingot: <mysticalagriculture:crafting:8>,
        block: <mysticalagriculture:crafting:8> * 9
    },
    ...
    platinum: {
        ...
        element: <alchemistry:element:78>
    },
    iridium: {
        ...
        element: <alchemistry:element:77>
    },
    titanium: {
        ...
        element: <alchemistry:element:22>
    },
    tungsten: {
        ...
        element: <alchemistry:element:74>
    },
    uranium: {
        ...
        element: <alchemistry:element:92>
    },
    yellorium: {
        ...
        element: <alchemistry:element:90>
    },
    ...
    bismuth: {
        ingot: <contenttweaker:bismuth_ingot>,
        block: <contenttweaker:bismuth_block>,
        dust: <contenttweaker:bismuth_dust>,

        element: <alchemistry:element:83>,
        singularity: <extendedcrafting:singularity_custom:106>
    },
    ...
    bismuth_bronze: {
        ingot: <contenttweaker:bismuth_bronze_ingot>,
        block: <contenttweaker:bismuth_bronze_block>
    },
    ...
    end_steel: {
        ...
        singularity: <extendedcrafting:singularity_custom:107>
    },
    melodic_alloy: {
    ...
    energetic_silver2: {
        ...
        singularity: <extendedcrafting:singularity_custom:92>
    },
    ...
    boarsteel: {
        ingot: <contenttweaker:boarsteel_ingot>,
        block: <contenttweaker:boarsteel_block>,

        ball: <contenttweaker:boarsteel_ball>,
        singularity: <extendedcrafting:singularity_custom:108>
    },
    vrt: {
        ingot: <contenttweaker:vrt_ingot>,
        block: <contenttweaker:vrt_block>,
        singularity: <extendedcrafting:singularity_custom:105>
    },
    ...
    batio: {
        ingot: <contenttweaker:batio>,
        block: <contenttweaker:batio> * 9
    },
    nethercotta: {
        ingot: <enderio:item_material:72>,
        block: <enderio:item_material:72> * 9
    },
    ...
    chrome: {
        ...
        element: <alchemistry:element:24>
    },
    palladium: {
        ...
        element: <alchemistry:element:46>
    },
    neodymium: {
        ...
        element: <alchemistry:element:60>
    },
    arkenium: {
    ...
    dralladium: {
        ...
        block: <contenttweaker:dralladium_block>,

        singularity: <extendedcrafting:singularity_custom:67>
    },
    purple_gold: {
    ...
    slate_steel: {
        ingot: <contenttweaker:slate_steel_ingot>,
        plate: <contenttweaker:slate_steel_plate>,
        rod: <contenttweaker:slate_steel_rod>,
        wire: <contenttweaker:slate_steel_wire>,
        block: <contenttweaker:slate_steel_block>
    },
    conductive_alloy: {
    ...
    gaia: {
        ...
        plate: <moreplates:gaia_spirit_plate>,
        gear: <moreplates:gaia_spirit_gear>,
        block: <moreplates:gaia_spirit_plate>
    },

    jet_alloy: {
        ingot: <contenttweaker:jet_alloy_ingot>,
        plate: <contenttweaker:jet_alloy_plate>,
        block: <contenttweaker:jet_alloy_block>
    },
    ...
    superconductor1: {
        ingot: <contenttweaker:superconductor1_ingot>,
        plate: <contenttweaker:superconductor1_plate>,
        wire: <contenttweaker:low_superconductor>,
        block: <contenttweaker:superconductor1_block>
    },
    zirconium: {
        ...
        element: <alchemistry:element:40>
    },
    kikeridan: {
        ingot: <contenttweaker:kikeridan_ingot>,
        plate: <contenttweaker:kikeridan_plate>,
        gear: <contenttweaker:kikeridan_gear>,
        block: <contenttweaker:kikeridan_block>,
    },
    ...
    beryllium: {
        ...
        element: <alchemistry:element:4>
    },
    polonium: {
        ingot: <alchemistry:ingot:84>,
        block: <contenttweaker:polonium_block>,
        dust: <contenttweaker:polonium_dust>,

        element: <alchemistry:element:84>
    },
    ...
    germanium: {
        ...
        singularity: <extendedcrafting:singularity_custom:102>
    },
    arsenic: {
        ingot: <alchemistry:ingot:33>,
        block: <contenttweaker:arsenic_block>,
        dust: <contenttweaker:arsenic_dust>,
        element: <alchemistry:element:33>,
        singularity: <extendedcrafting:singularity_custom:111>
    },
    selenium: {
        ingot: <alchemistry:ingot:34>,
        block: <contenttweaker:selenium_block>,
    ...
    rhodium: {
        ...
        singularity: <extendedcrafting:singularity_custom:103>
    },
    cadmium: {
        ingot: <alchemistry:ingot:48>,
        block: <contenttweaker:cadmium_block>,
        dust: <contenttweaker:cadmium>,
        element: <alchemistry:element:48>
    },
    tellurium: {
        ingot: <alchemistry:ingot:52>,
        block: <contenttweaker:tellurium_block>,
        dust: <contenttweaker:tellurium_dust>,
        element: <alchemistry:element:52>
    },
    barium: {
    ...
    gerdurmol: {
        ingot: <contenttweaker:gerdurmol_ingot>,
        block: <contenttweaker:gerdurmol_ingot> * 9
    },
    vanadium_alloy: {
    ...
    perovskite: {
        ...
        plate: <contenttweaker:perovskite_plate>,
        block: <contenttweaker:perovskite_block>
    },
    perovskite2: {
        ingot: <contenttweaker:perovskite2_ingot>,
        plate: <contenttweaker:perovskite2_plate>,
        block: <contenttweaker:perovskite2_block>
    },
    ...
    tritonite: {
        ...
        singularity: <extendedcrafting:singularity_custom:104>
    },
    ...
    prometheum: {
        ...
        element: <alchemistry:element:61>
    },
    duranite: {
    ...
    meteorite: {
        ...
        singularity: <extendedcrafting:singularity_custom:35>
    },
    obsidiorite: {
    ...
    zracohlium: {
        ingot: <moretcon:ingotzracohlium>,
        block: <moretcon:blockzracohlium>,
        dust: <moretcon:dustzracohlium>
    },
    fusionite: {
        ingot: <moretcon:ingotfusionite>,
        block: <moretcon:blockfusionite>,
        dust: <moretcon:dustfusionite>
    },
    sanguiseelium: {
    ...
    geode: {
        ingot: <thermalfoundation:geode>,
        block: <thermalfoundation:geode> * 9,
        dust: <thermalfoundation:geode>
    },
    ...
    calcium: {
        ingot: <contenttweaker:calcium>,
        block: <contenttweaker:calcium> * 9,
        dust: <contenttweaker:calcium>
    },
    black_paste: {
        ingot: <contenttweaker:black_paste>,
        block: <contenttweaker:black_paste> * 9,
        dust: <contenttweaker:black_paste>
    },
    solar_silicon: {
...
static all_metals_molten as ILiquidStack[string] = {
    ...
    ironwood: <liquid:liquidironwood>,
    ...
    zracohlium: <liquid:liquidzracohlium>,
    fusionite: <liquid:liquidfusionite>,
    sanguiseelium: <liquid:liquidsanguiseelium>,
...
static metals_to_clean as string[] = [
    ...
    "mana_steel", "elementium", "terra_steel", "mirion", "gaia",
...
function add2alloy(
    ...
    if (alloy_level <= 4){
        ...
        mods.enderio.AlloySmelter.addRecipe(all_metals[alloy].ingot * alloyn, 
            [
                all_metals[metal1].ingot * n1,
                all_metals[metal2].ingot * n2
            ], 16000 * (alloy_level + 1) * (alloy_level + 1)
        );
    ...
    if (all_metals[alloy].keys has "singularity")
    if (all_metals[metal1].keys has "singularity")
    if (all_metals[metal2].keys has "singularity")
    {
        var rec2 = RecipeBuilder.newBuilder("alloy_compression_" ~ alloy ~ "_" ~ metal1 ~ metal2, "explosion_compressor", 3 * 20);
        rec2.addEnergyPerTickInput(8192);
        rec2.addItemOutput(all_metals[alloy].singularity * alloyn);
...
function add3alloy(
    ...
    mods.enderio.AlloySmelter.addRecipe(all_metals[alloy].ingot * alloyn, 
        ...
        ], 32000 * (alloy_level + 1) * (alloy_level + 1)
    );
    ...
    if (all_metals[metal1].keys has "singularity")
    if (all_metals[metal2].keys has "singularity")
    if (all_metals[metal3].keys has "singularity")
    {
        var rec2 = RecipeBuilder.newBuilder("alloy_compression_" ~ alloy ~ "_" ~ metal1 ~ metal2 ~ metal3, "explosion_compressor", 3 * 20);
        rec2.addEnergyPerTickInput(8192);
        rec2.addItemOutput(all_metals[alloy].singularity * alloyn);
...
function add2_3alloy(alloy_level as int, alloy as string, alloyn2 as int, alloyn3 as int, 
    metal1 as string, n1 as int, 
    metal2 as string, n2 as int,
    metal3 as string, n3 as int){

    mods.immersiveengineering.AlloySmelter.addRecipe(
        all_metals[alloy].ingot * alloyn2, 
        all_metals[metal1].ingot * n1,
        all_metals[metal2].ingot * n2,
        200
    );
    ...
    add3alloy(alloy_level, alloy, alloyn3,
        metal1, n1,
        metal2, n2,
        metal3, n3
    );
...
function addElement(nam as string){
    ...
    if (all_metals_molten.keys has nam) {
...
function addAdvancedSmelting(ingot as IItemStack, dust as IItemStack, flux1 as IItemStack, flux2 as IItemStack, fluxL as ILiquidStack, rft as int, time as int){
    mods.enderio.AlloySmelter.addRecipe(ingot * 2, 
        [
            dust * 3,
            flux1, flux2
        ], rft * time
    ...
    {
        var rec = RecipeBuilder.newBuilder("adv_smelting_" ~ counter, "high_oven", time);
        rec.addEnergyPerTickInput(rft);

        rec.addItemOutput(ingot * 2);
    
        rec.addItemInput(dust * 3);
        rec.addItemInput(flux1);
        rec.addFluidInput(fluxL);
...
{//main part
    ...
    recipes.addShaped("plate_hammer_recipe_blocks", <moreplates:hammer>, [
    ...
    for metal in all_metals {
        ...
        if (all_metals_molten has metal) {
            ...
            {
                var rec = RecipeBuilder.newBuilder("casting_" ~ metal, "ingot_caster", 2);
                rec.addEnergyPerTickInput(200);

                rec.addItemOutput(all_metals[metal].ingot);
            
                rec.addItemInput(<contenttweaker:empty_ingot>);
                rec.addFluidInput(all_metals_molten[metal] * 144);
...
{//early game
    ...
    {//simple alloys
        ...
        {//steel
            var rec = RecipeBuilder.newBuilder("grand_steel_rec", "tignalum_oven", 10 * 20);
            rec.addEnergyPerTickInput(1000 * 1000);

            rec.addItemOutput(<thermalfoundation:material:160> * 64);
            rec.addItemInput(<mekanism:enrichediron> * 1024);
            rec.addItemInput(<alchemistry:compound:500> * 256);
            
            for item,stat in {
                <contenttweaker:fluix_steel_ingot> * 64: 1.15,
                <contenttweaker:soy_ingot> * 64: 1.25,

                <contenttweaker:duraluminumwood_ingot> * 64: 1.2,
                <moretcon:ingotrunesteel> * 64: 1.2,
                <contenttweaker:flower_steel_ingot> * 64: 1.2,

                <contenttweaker:living_steel_ingot> * 32: 1.35,
                <contenttweaker:darker_steel_ingot> * 32: 1.35,
                ...
                <contenttweaker:wormholium> * 16: 1.6,
                <contenttweaker:sin_nickel_ingot> * 16: 1.6,

                <extendedcrafting:material:32> * 4: 1.75,
                <avaritia:resource:4> * 4: 2,
                <avaritia:resource:6>: 2.5
            } as float[IItemStack]
            {
                rec.addCatalystInput(
                        ...
                        [RecipeModifierBuilder.create(
                            "modularmachinery:item", "output", stat, 1, false
                        ).build()]
                ).setChance(0.5);
            }
...
{//thermal
    {//thermal_steel
        ...
        scripts.content_machines.addFluidAlloyerRecipe(
            <contenttweaker:compound_metal2> * 6, 
            <contenttweaker:compound_metal> * 4, <alchemistry:ingot:42> | <alchemistry:ingot:73> | <contenttweaker:tinezo_ingot>, 
            <liquid:formic_acid> * 1000, 
            40, 512
        );
        scripts.content_machines.addFluidAlloyerRecipe(
            <contenttweaker:compound_metal2> * 5, 
            <contenttweaker:compound_metal> * 4, <alchemistry:ingot:74>, 
            <liquid:formic_acid> * 1000, 
            40, 512
        );
    ...
    {//enderium 
        ...
        add2_3alloy(1, "enderium_base", 2, 6,
            "mushroomite", 3,
            "platinum", 1,
            "cadmium", 1
        );
    ...
    {//mekanized_steel
        ...
        scripts.content_machines.addAdvancedMixerRecipe(
            [<contenttweaker:mekanized_steel_base_ingot> * 5], [],
            [
                all_metals.electric_manyullyn.ingot,
                all_metals.enderium.ingot,
                all_metals.thermal_steel.ingot,
                <alchemistry:ingot:42> | <taiga:uru_ingot> | <contenttweaker:ancient_ingot>
            ], [
                <liquid:empoweredoil> * 1500
            ], 4, 100000
        );
        scripts.content_machines.addAdvancedMixerRecipe(
            [<contenttweaker:mekanized_steel_base_ingot> * 6], [],
            [
                all_metals.electric_manyullyn.ingot,
                all_metals.enderium.ingot,
                all_metals.thermal_steel.ingot,
        ...
        scripts.content_machines.addFluidAlloyerRecipe(
            <contenttweaker:mekanized_steel_ingot> * 6, 
            <contenttweaker:mekanized_steel_base_ingot> * 4, <taiga:duranite_ingot> | <contenttweaker:amethyst_ingot>, <liquid:mekanization_catalyst> * 1000, 
            80, 1000
        );
    }    
}
...
{//mekanism
    ...
    scripts.helper.addFluidAlloyerRecipe(
        ...
        all_metals.watertight_steel.ingot * 2, <contenttweaker:hot_energion> * 1, <liquid:mercury> * 200, 
        512, 60
    );
    ...
    {//fluxed electrum
        ...
        scripts.helper.addFluidAlloyerRecipe(
            ...
            <contenttweaker:gold_crystal> * 4, <thermalfoundation:material:97> * 12, <liquid:redstone_alloy> * 576, 
            512, 120
        );
        ...
        scripts.helper.addFluidAlloyerRecipe(
            ...
            <contenttweaker:prefluxed_electrum_blend>, <twilightforest:fiery_ingot> * 2, <liquid:liquidfusionfuel> * 750, 
            512, 120
        );
    }
...
{//twilight
    ...
    //ironwood
    furnace.remove(<twilightforest:ironwood_ingot> * 2, <twilightforest:ironwood_raw>);
    mods.thermalexpansion.Pulverizer.addRecipe(<moretcon:dustironwood>, <twilightforest:ironwood_raw>, 3000, <moretcon:dustironwood>, 10);
    mods.enderio.SagMill.addRecipe([
            <moretcon:dustironwood>, <moretcon:dustironwood>, <moretcon:dustironwood>
        ], [0.75, 0.25, 0.25], <twilightforest:ironwood_raw>, "MULTIPLY_OUTPUT"
    );

    TEAlloyer.addRecipe(
        <twilightforest:ironwood_ingot> * 4, 
        <twilightforest:ironwood_raw> * 2, <contenttweaker:stoneleaf>, 5000, 
        <contenttweaker:whitened_biomass>, 25
    );
    TEAlloyer.addRecipe(
        <twilightforest:ironwood_ingot> * 4, 
        <twilightforest:ironwood_raw> * 2, <contenttweaker:empowered_biospice>, 5000, 
        <contenttweaker:whitened_biomass>, 25
    );
...
{//AA
    {//black_bronze
        {//blue paste
            mods.mekanism.infuser.addRecipe("CHEESE", 20, <taiga:ovium_ingot>, <contenttweaker:blue_paste>);
            mods.mekanism.infuser.addRecipe("CHEESE", 20, <moretcon:ingotfusionite>, <contenttweaker:blue_paste> * 2);
            mods.mekanism.infuser.addRecipe("CHEESE", 20, <taiga:tritonite_ingot>, <contenttweaker:blue_paste> * 2);
            mods.mekanism.infuser.addRecipe("CHEESE", 20, <minecraft:dye:4> * 2, <contenttweaker:blue_paste>);
        }
        {//black paste
            mods.mekanism.reaction.addRecipe(
                <contenttweaker:blue_paste>, <liquid:tungsten> * 288, <gas:hexane> * 250, 
                <contenttweaker:black_paste>, <gas:waste_gas> * 10, 1000, 20
            );
            mods.mekanism.reaction.addRecipe(
                <contenttweaker:blue_paste>, <liquid:molybdenum> * 288, <gas:hexane> * 250, 
                <contenttweaker:black_paste> * 2, <gas:waste_gas> * 50, 1000, 20
            );
            mods.mekanism.reaction.addRecipe(
                <contenttweaker:blue_paste>, <liquid:tungsten> * 288, <gas:methane> * 250, 
                <contenttweaker:black_paste> * 1, <gas:waste_gas> * 50, 1000, 20
            );
            mods.mekanism.reaction.addRecipe(
                <contenttweaker:blue_paste>, <liquid:molybdenum> * 288, <gas:methane> * 250, 
                <contenttweaker:black_paste> * 2, <gas:waste_gas> * 150, 1000, 20
            );
...
{//noble & imperomite
    ...
    {//imperial steel
        ...
        mods.enderio.AlloySmelter.addRecipe(<contenttweaker:imperial_iron_ingot>, 
            [
                <contenttweaker:imperial_dust2> * 1,
                <contenttweaker:viking_metal> * 3,
                <contenttweaker:imperomite_catalyst>
            ],
            20000
        );
...
{//viking metal
    mods.extendedcrafting.CombinationCrafting.addRecipe(
        <contenttweaker:viking_metal> * 3, 10240 * 20, 10240, <contenttweaker:glass_ingot>,
        [
            <twilightforest:knightmetal_ingot>, <twilightforest:knightmetal_ingot>, <twilightforest:knightmetal_ingot>, <twilightforest:knightmetal_ingot>,
            <moretcon:gemelectarite>, <moretcon:gemelectarite>, <alchemistry:ingot:21>, <bigreactors:ingotyellorium>
        ]
    );
}
...
addAdvancedSmelting(
    <contenttweaker:neodymium_ingot>, <contenttweaker:neodymium_dust>,
    <prodigytech:aeternus_crystal>, <contenttweaker:duraluminum_dust>, <liquid:high_heat_lava> * 100, 
    10000, 20 * 30
);
...
{//blood magic
    //bismuth_bronze
    add2_3alloy(3, "bismuth_bronze", 2, 4, 
        "black_bronze", 3, 
        "bismuth", 8,
        "geode", 1
    );
    add3alloy(3, "bismuth_bronze", 4, 
        "black_bronze", 3, 
        "bismuth", 8,
        "selenium", 2
    );
...
{//botania
    ...
    {//orichalconite
        mods.extendedcrafting.CombinationCrafting.addRecipe(
            <contenttweaker:orichalconite_ingot> * 2, 10240 * 20, 10240, <contenttweaker:glass_ingot>,
            [
        ...
        mods.extendedcrafting.CombinationCrafting.addRecipe(
            <contenttweaker:orichalconite_ingot> * 3, 10240 * 20, 10240, <contenttweaker:glass_ingot>,
            [
                <contenttweaker:orichalcum_ingot>,
                <contenttweaker:orichalcum_ingot>,
                <twilightforest:knightmetal_block>,
...
{//astral
    ...
    scripts.content_machines.addAdvancedMixerRecipe(
        [<contenttweaker:jet_alloy_ingot> * 4], [],
        [
            <contenttweaker:explosion_resistant_ingot> * 16,
            <extendedcrafting:singularity_custom:74>,
            <enderio:item_material:72> * 8,
            //<contenttweaker:elemental_essence>
        ], [
            <liquid:yellow> * 2000, 
            <liquid:super_heat_lava> * 500
        ],
        40, 10240
    );
...
{//alchemistry
    ...
    addAdvancedSmelting(
        <alchemistry:ingot:4>, <contenttweaker:beryllium_dust>,
        <prodigytech:aeternus_crystal>, <actuallyadditions:item_crystal_empowered:5>, <liquid:high_heat_lava> * 50, 
        10000, 20 * 30
    );
    scripts.helper.addSimpleCrushingRecipe(<alchemistry:ingot:4>, <contenttweaker:beryllium_dust>);

    addAdvancedSmelting(
        <alchemistry:ingot:21>, <contenttweaker:scandium_dust>,
        <prodigytech:aeternus_crystal>, <moretcon:gemelectarite>, <liquid:high_heat_lava> * 50, 
        10000, 20 * 30
    );
    ...
    mods.extendedcrafting.CombinationCrafting.addRecipe(
        <contenttweaker:superconductor1_ingot> * 6, 1024000 * 100, 1024000 * 5, <contenttweaker:super_alloy_base_ingot>,
        [
            <alchemistry:ingot:41>,
            <alchemistry:ingot:41>,
            <alchemistry:ingot:41>,
            <alchemistry:ingot:32>,
            <plustic:mirioningot>,
    ...
    mods.extendedcrafting.CombinationCrafting.addRecipe(
        <contenttweaker:superconductor1_ingot> * 12, 1024000 * 100, 1024000 * 5, <contenttweaker:super_alloy_base_ingot>,
        [
            <alchemistry:ingot:41>,
            <alchemistry:ingot:41>,
            <alchemistry:ingot:41>,
...
{//draconic
    ...
    //dralladium
    add3alloy(4, "dralladium", 1, 
        "draconium", 4,
        "palladium", 3,
        "neodymium", 3
    );
    add3alloy(4, "dralladium", 2, 
        "draconium", 4,
        "palladium", 3,
        "starmetal", 3
    );
...
{//moretcon
    ...
    Transposer.addFillRecipe(<moretcon:itemvalasiumsponge:2>, <moretcon:itemvalasiumsponge:1>, <liquid:liquidfusionite> * 288, 8000);
    Transposer.addFillRecipe(<moretcon:itemvalasiumsponge:3>, <moretcon:itemvalasiumsponge:2>, <liquid:gallium> * 576, 8000);
    ...
    Transposer.addFillRecipe(<moretcon:itemvalasiumsponge:4>, <moretcon:itemvalasiumsponge:3>, <liquid:liquidgravitonium> * 1296, 8000);
    Transposer.addFillRecipe(<moretcon:itemvalasiumsponge:5>, <moretcon:itemvalasiumsponge:4>, <liquid:cobalt> * (144 * 4 * 9), 8000);
    Transposer.addFillRecipe(<moretcon:itemvalasiumsponge>, <moretcon:itemvalasiumsponge:5>, <liquid:liquidrunesteel> * (144 * 12), 8000);
    ...
    //sanguiseelium
    Transposer.addFillRecipe(<moretcon:itemsanguiseeliumsponge:2>, <moretcon:itemsanguiseeliumsponge:1>, <liquid:liquidhallowsite> * 576, 8000);
    Transposer.addFillRecipe(<moretcon:itemsanguiseeliumsponge:3>, <moretcon:itemsanguiseeliumsponge:2>, <liquid:gallium> * 288, 8000);
    mods.tconstruct.Casting.addBasinRecipe(<moretcon:itemsanguiseeliumsponge:3>, <moretcon:itemsanguiseeliumsponge:2>, <liquid:gallium>, 144 * 2, true);
    Transposer.addFillRecipe(<moretcon:itemsanguiseeliumsponge:4>, <moretcon:itemsanguiseeliumsponge:3>, <liquid:liquifiedsouls> * 576, 8000);
    Transposer.addFillRecipe(<moretcon:itemsanguiseeliumsponge>, <moretcon:itemsanguiseeliumsponge:4>, <liquid:blood> * 2000, 8000);

    scripts.content_machines.addAdvancedMixerRecipe(
        [<moretcon:itemsanguiseeliumsponge>], [], 
        [<moretcon:itemsanguiseeliumsponge:1>], [
            <liquid:blood> * 2000,
            <liquid:gallium> * 288,
            <liquid:liquidhallowsite> * 576,
            <liquid:liquifiedsouls> * 576
        ], 
        120, 2000
    );
}
...
{//mystical alloys
    ...
    /*scripts.content_machines.addAdvancedMixerRecipe(
        ...
        ], [<liquid:osmiridium> * 144], 120, 2000
    );*/
    ...
    add3alloy(4, "mystical_metal3", 1,
        "mystical_metal2", 2,
        "fusionite", 4,
        "sentient", 2
    );

    add3alloy(4, "mystical_metal4", 1,
        "mystical_metal3", 2,
        "bound", 3,
        "sanguiseelium", 2
    );
