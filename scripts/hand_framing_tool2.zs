...
/*
 * Copied and edited from dj2 which itself:
...
val sideIngredient = previewIngredient(<extrautils2:decorativesolid:8>, "MatS");
val trimIngredient = previewIngredient(<contenttweaker:titanworm_steel_block>, "MatT");
