...
{//cutting
    ...
    addRuneCutting([<contenttweaker:improved_rune_base> * 6, <contenttweaker:methyst_dirty_dust> * 3], [
        ...
        <contenttweaker:methyst> * 3
    ], [<contenttweaker:improved_rune_base> * 4, <contenttweaker:rune_base> * 3]);
    
    addRuneCutting([<contenttweaker:advanced_rune_base> * 6], [
        <contenttweaker:rune_boule3>,
        <contenttweaker:bug_chip>,
        <contenttweaker:super_vibrant_plate> * 12,
        <contenttweaker:gem_steel_plate> * 12,
        <mysticalagriculture:crafting:4> * 3,
        <contenttweaker:improved_rune_base> * 2
